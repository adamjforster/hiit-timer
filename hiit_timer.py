...
def main():
    ...
    parser.add_argument('normal', type=int, help='Time in seconds for normal-intensity exercise.')
    parser.add_argument('reps', type=int, help='Number of repetitions of high/normal exercise.')
